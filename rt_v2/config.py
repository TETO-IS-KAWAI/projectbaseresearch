...
class Config:
    ...
    fg_T0_k:       float = 2.0    # |b|≈90° 기준 T [K]
    fg_beta:       float = 2.7    # |sin b|^(-beta)
    fg_b_min_deg:  float = 3.0    # 은하면 하한 [deg]
    fg_scale:      float = 1.0    # 차감 비율 0~1

    _singleton: ClassVar[Optional['Config']] = None
